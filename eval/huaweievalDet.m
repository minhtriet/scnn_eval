function [pr_all,ap_all,map]=huaweievalDet(detfilename,gtpath,subset,threshold)
...
function [rec,prec,ap]=huaweieventdetpr(detevents,gtevents,class,overlapthresh)
...
for i=1:length(videonames)
  ...
  ov=intervaloverlapvalseconds(cat(1,gtevents(:).timeinterval),cat(1,detevents(:).timeinterval));
